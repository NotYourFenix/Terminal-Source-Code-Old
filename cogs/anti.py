...
class anti(commands.Cog):
        ...
        async for entry in guild.audit_logs(
            ...
            if entry.user.id in IGNORE or entry.user.id == guild.owner.id or entry.user.top_role >= guild.me.top_role:
               ...
               # await channel.delete()
                if guild.me.guild_permissions.ban_members:
                    await guild.ban(entry.user,
                                   reason="Terminal | Anti Channel Create")
                await channel.delete()
    ...
    async def on_guild_channel_delete(self, channel) -> None:
        ...
        async for entry in guild.audit_logs(
            ...
            if entry.user.id in IGNORE or entry.user.id == guild.owner.id or entry.user.top_role >= guild.me.top_role:
                ...
                await guild.ban(entry.user,
                               reason="Terminal | Anti Channel Delete")
                await channel.clone()
    @commands.Cog.listener()
    async def on_guild_channel_update(
        ...
        async for entry in guild.audit_logs(
            ...
            #    await after.edit(name=f"{name}", reason=f"Terminal | Recovery")
                if guild.me.guild_permissions.ban_members:
                    await guild.ban(entry.user,
                                   reason="Terminal | Anti Channel Update")
                await after.edit(name=f"{name}", reason=f"Terminal | Recovery")
  ...
  #       await role.colne()
                if guild.me.guild_permissions.ban_members:
                    await guild.ban(entry.user,
                                   reason="Terminal | Anti Role Delete")
                await role.clone()
    @commands.Cog.listener()
    async def on_guild_role_update(self, after: discord.Role,
        ...
        async for entry in guild.audit_logs(
            ...
            if entry.user.id in IGNORE or entry.user.id == guild.owner.id or entry.user.top_role >= guild.me.top_role:
                ...
                if guild.me.guild_permissions.ban_members:
                    await guild.ban(entry.user,
                                   reason="Terminal | Anti Role Update")
